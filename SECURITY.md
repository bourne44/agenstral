...
Agenstral is security tooling, but it is not a sandbox. A denied call is blocked before execution when routed through an Agenstral proxy. A call that bypasses Agenstral is outside its control.
